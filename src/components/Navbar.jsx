...
const Navbar = ({ activePage, handleNavPage, isNavbarOpen, toggleNavbar }) => {
  return (
    <>
      <div className={`2xl:w-80 xl:w-52 w-44 h-full bg-[#f8f8f8] flex flex-col justify-between pt-5 pl-6 pb-14 md:pb-0 absolute md:relative z-10 ${isNavbarOpen ? 'translate-x-0' : '-translate-x-110'} transition-transform duration-300`}>
        ...
        <div className="flex flex-col flex-grow">
          {navItems.map((item, index) => (
            ...
            >
              <i className={`${item.icon} text-xl text-pink-400`}>
              </i>
