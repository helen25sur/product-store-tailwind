...
export const macbookModels = [
  {
    ...
    colors: [
      { label: 'Space gray', bg: '#b2b5b8', bgLabel: 'space-gray', img: 'images/macbook-air-spacegray-m2.jpg' },
      { label: 'Gold', bg: '#f0e0d3', bgLabel: 'gold', img: 'images/macbook-air-gold-m2.jpg' },
      { label: 'Silver', bg: '#e0e2e1', bgLabel: 'silver', img: 'images/macbook-air-silver-m2.jpg' },
    ],
  ...
  },
  {
    ...
    colors: [
      { label: 'Midnight', bg: '#2e3641', bgLabel: 'midnight', img: 'images/macbook-air-midnight-m3.jpg' },
      { label: 'Starlight', bg: '#f0e5d3', bgLabel: 'starlight', img: 'images/macbook-air-starlight-m3.jpg' },
      { label: 'Space gray', bg: '#7d7e80', bgLabel: 'space-gray-2', img: 'images/macbook-air-spacegray-m3.jpg' },
      { label: 'Silver', bg: '#e3e4e6', bgLabel: 'silver-2', img: 'images/macbook-air-silver-m3.jpg' },
    ],
